...
console.log('------------------------------------------》1')
//utf-8编码后的16进制字符串
console.log(CryptoJS.enc.Utf8.parse("xiaojianbang").toString());
//16进制解码后的16进制字符串
console.log(CryptoJS.enc.Hex.parse("7869616f6a69616e62616e67").toString());
//base64解码后的16进制字符串
console.log(CryptoJS.enc.Base64.parse("eGlhb2ppYW5iYW5n").toString());
...
//xiaojianbangsaltstr的16进制字符串即为7869616f6a69616e62616e6773616c74737472
var md5Str = "xiaojianbangsaltstr";
console.log(CryptoJS.MD5(md5Str).toString());

//需要先解析此16进制字符串，转为字节数组，如何进行md5加密（结果是一样的）
